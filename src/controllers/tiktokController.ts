...
export class TiktokController {
  // Publier une vidéo d'un candidat validé sur TikTok (sans authentification)
  static async publishVideoDirect(req: Request, res: Response): Promise<void> {
    try {
      ...
      console.log('🎵 Publication TikTok créée (sans auth):', {
        artisteId,
        caption: fullCaption,
        hashtags: allHashtags
      });
      ...
      console.error('Erreur publication TikTok (direct):', error);
      res.status(500).json({
        success: false,
